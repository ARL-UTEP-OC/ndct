...
function SystemCalls_proto.dissector(buffer,pinfo,tree)
    ...
    if pinfo.abs_ts >= 1593628835.0 and pinfo.abs_ts <= 1593628837.0 then
       ...
       subtree:add(tostring("Original Timestamp: "),tostring("2020-07-01T18:40:35"))
    ...
    if pinfo.abs_ts >= 1593628835.0 and pinfo.abs_ts <= 1593628837.0 then
       local subtree = tree:add(SystemCalls_proto,"SystemCalls Log")
       local mycomplientstr = tostring("cat /home/kali/eceld-netsys/eceld/plugins/collectors/auditd/raw/1593628834_auditd.txt")
