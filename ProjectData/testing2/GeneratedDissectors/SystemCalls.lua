...
function SystemCalls_proto.dissector(buffer,pinfo,tree)
    ...
    if pinfo.abs_ts >= 1594056509.0 and pinfo.abs_ts <= 1594056511.0 then
       ...
       subtree:add(tostring("Original Timestamp: "),tostring("2020-07-06T17:28:29"))
    ...
    if pinfo.abs_ts >= 1594056509.0 and pinfo.abs_ts <= 1594056511.0 then
       local subtree = tree:add(SystemCalls_proto,"SystemCalls Log")
       local mycomplientstr = tostring("cat /home/kali/eceld-netsys/eceld/plugins/collectors/auditd/raw/1594056499_auditd.txt")
