...
function SystemCalls_proto.dissector(buffer,pinfo,tree)
    ...
    if pinfo.abs_ts >= 1593468035.0 and pinfo.abs_ts <= 1593468037.0 then
       ...
       subtree:add(tostring("Original Timestamp: "),tostring("2020-06-29T22:00:35"))
    ...
    if pinfo.abs_ts >= 1593468035.0 and pinfo.abs_ts <= 1593468037.0 then
       local subtree = tree:add(SystemCalls_proto,"SystemCalls Log")
       local mycomplientstr = tostring("cat /home/kali/eceld-netsys/eceld/plugins/collectors/auditd/raw/1593468033_auditd.txt")
