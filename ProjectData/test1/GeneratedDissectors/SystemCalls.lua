...
function SystemCalls_proto.dissector(buffer,pinfo,tree)
    ...
    if pinfo.abs_ts >= 1594074567.0 and pinfo.abs_ts <= 1594074569.0 then
       ...
       subtree:add(tostring("Original Timestamp: "),tostring("2020-07-06T22:29:27"))
    ...
    if pinfo.abs_ts >= 1594074567.0 and pinfo.abs_ts <= 1594074569.0 then
       local subtree = tree:add(SystemCalls_proto,"SystemCalls Log")
       local mycomplientstr = tostring("cat /home/kali/eceld-netsys/eceld/plugins/collectors/auditd/raw/1594074566_auditd.txt")
