...
function SystemCalls_proto.dissector(buffer,pinfo,tree)
    ...
    if pinfo.abs_ts >= 1593467745.0 and pinfo.abs_ts <= 1593467747.0 then
       ...
       subtree:add(tostring("Original Timestamp: "),tostring("2020-06-29T21:55:45"))
    ...
    if pinfo.abs_ts >= 1593467745.0 and pinfo.abs_ts <= 1593467747.0 then
       local subtree = tree:add(SystemCalls_proto,"SystemCalls Log")
       local mycomplientstr = tostring("cat /home/kali/eceld-netsys/eceld/plugins/collectors/auditd/raw/1593467743_auditd.txt")
